...
from pymongo.asynchronous.collection import AsyncCollection as OriginalAsyncCollection
...
class AsyncMongoCollection(typing.Generic[DocumentT]):
    """
    Асинхронная обертка над стандартной коллекцией MongoDB.
    ...
    def __init__(
        self,
        *,
        collection: OriginalAsyncCollection,
    ) -> None:
        """
        Инициализирует обертку для коллекции.

        :param collection: Экземпляр оригинальной асинхронной коллекции PyMongo.
        """
        self._collection: OriginalAsyncCollection = collection
    ...
    def _document_model(self) -> type[DocumentT]:
        ...
        if orig_class is None:
            raise TypeError(
                ...
                "Убедись, что класс параметризован: AsyncMongoCollection[MyModel](...)"
            )
    ...
    @property
    def c(self) -> OriginalAsyncCollection:
        """
    ...
    async def insert_one(
        ...
        """
        return await self.c.insert_one(
    ...
    async def insert_many(
        ...
        :return: Результат операции вставки.
        """
        return await self.c.insert_many(
    ...
    async def find_one(
        ...
        """
        raw_result = await self.c.find_one(
    ...
    async def find(
        self, filter: dict[str, typing.Any], *args: typing.Any, **kwargs: typing.Any
    ) -> typing.AsyncGenerator[DocumentT, None]:
        """
        Находит все документы, соответствующие фильтру, и возвращает асинхронный генератор.

        Фильтр конвертируется для запроса. Каждый найденный документ
        преобразуется в экземпляр Pydantic-модели.

        :param filter: Словарь с условиями фильтрации.
        :return: Асинхронный генератор, возвращающий экземпляры Pydantic-моделей.
        """
    ...
    async def update_one(
        ...
        """
        return await self.c.update_one(
    ...
    async def update_many(
        ...
        :return: Результат операции обновления.
        """
        return await self.c.update_many(
            utils.recursive_convert_to(filter),
            utils.recursive_convert_to(update),
            upsert=upsert,
            array_filters=array_filters,
    ...
    async def delete_one(
        ...
        """
        return await self.c.delete_one(
            utils.recursive_convert_to(filter),
            collation=collation,
            hint=hint,
            session=session,
    ...
    async def delete_many(
        ...
        :return: Результат операции удаления.
        """
        return await self.c.delete_many(
            utils.recursive_convert_to(filter),
            collation=collation,
            hint=hint,
            session=session,
